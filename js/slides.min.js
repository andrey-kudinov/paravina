...
$(document).ready(function() {
    ...
    function f() {
        ...
        $(".slide").each(function(a, b) {
            ...
            !(k > -1 && k < 1) || window.allowParallaxOnMobile && window.isMobile || (c.hasClass("parallax") || c.find(".parallax-element")) && c.find(".parallax-element").each(function() {
                var a = $(this)
    ...
    function l(a, b) {
        ...
        h.addClass("show").css("top", e).css("left", f),
        $html.addClass("dropdownShown dropdown_" + g),
        window.dropdownShown = !0
    }
    function m() {
        window.dropdownShown && ($html.removeClass("dropdownShown").removeClassByPrefix("dropdown_"),
    ...
    window.isScroll || window.isSimplifiedMobile)) {
        var q, r = 0, s = window.hideOnScrollSensitivity ? window.hideOnScrollSensitivity : 100, t = $(".panel.hideOnScroll");
        $(window).on("mousewheel", function(a) {
            ...
            c.removeClass("hide"))),
            q = b,
            (b + window.windowHeight + s >= window.documentHeight || b + s <= 0) && c.removeClass("hide")
        })
    }
    $(document).on("keydown", function(a) {
        var b = 2.5
          ...
          , f = d.scrollTop()
          , g = f + parseInt(b * c);
        window.disableKeyNavigation || "input" == a.target.nodeName.toLowerCase() || "textarea" == a.target.nodeName.toLowerCase() || (37 === a.keyCode && (a.preventDefault(),
        window.horizontalMode && window.changeSlide("decrease")),
        38 === a.keyCode && (window.horizontalMode ? (a.preventDefault(),
        ...
        window.changeSlide("decrease"))),
        39 === a.keyCode && window.horizontalMode && (a.preventDefault(),
        window.changeSlide("increase")),
        40 === a.keyCode && (window.horizontalMode ? (a.preventDefault(),
        TweenLite.to(d, window.scrollSpeed, {
            scrollTo: {
                y: g,
                autoKill: !0
    ...
    window.showPopup = function(a) {
        ...
        $html.addClass("popupShown popup_" + b),
        $(c).find(".content").scrollTop(0),
        window.allowSlide = 0,
        window.popupShown || (window.popupShown = []),
        window.popupShown.push(b),
        $(c).hasClass("autoplay"))) {
            var e = $(c)
              , f = e.find("iframe")
              , g = e.find("video");
            if (f.length > 0) {
                var h = $(f).attr("src") ? $(f).attr("src") : $(f).data("src")
                  , j = h.indexOf("?") > -1 ? "&" : "?";
    ...
    $("[data-slider-action]").click(function() {
        if ($(this).data("slider-id")) {
            var a, b, c = $(this), d = c.data("slider-id"), e = c.data("slider-action"), f = $('.slider[data-slider-id="' + d + '"]'), g = $('.controller[data-slider-id="' + d + '"]');
